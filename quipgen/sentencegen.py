...
# This file runs on the AWS server.
# Derived from https://github.com/huggingface/transformers/blob/master/examples/run_generation.py
# As adapted for https://github.com/fenceFoil/FindRealHumansNearYouGame/blob/master/gpt2api/src/app.py 
