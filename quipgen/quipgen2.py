...
def gpt2():
    ...
    subprocess.call('python run_generation.py --seed {} --model_type gpt2 --num_samples 10 --model_name_or_path distilgpt2 --prompt "{}"'.format(random.randint(0, 100000000), prompt), shell=True)
